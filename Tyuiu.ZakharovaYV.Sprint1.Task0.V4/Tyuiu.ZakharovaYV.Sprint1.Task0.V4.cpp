// Tyuiu.ZakharovaYV.Sprint1.Task0.V4.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	cin >> b;
	cout << "Площадь прямоугольника = " << date->Rezalt(a, b);
	cout << endl;
